...
export function Visualizer({ events }: VisualizerProps) {
  ...
  const EventCard = ({ event, className }: { event: Event; className?: string }) => (
    <div className={cn("bg-white rounded-xl shadow-sm border border-slate-200 p-3 hover:shadow-md transition-shadow", className)}>
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="bg-[#3b5998] text-white py-4 px-6 rounded-2xl shadow-md mb-8 flex items-center justify-between">
          ...
          <div className="text-blue-100 font-medium">{events.length} Events Total</div>
        </header>
